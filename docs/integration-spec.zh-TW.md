...
最後更新：2026-03-25（本次更新：新增查價功能對齊規格文件連結）
...
自 2026-03-25 起，查價模組的完整對齊規格已獨立整理為 [`market-parity-spec.zh-TW.md`](./market-parity-spec.zh-TW.md)。  
本節保留整體整合摘要；若要規劃查價頁的下一階段實作，應優先閱讀新文件。
